...
export default function Gallery() {
  return (
    <div id="gallery"  className="scroll-mt-[50px] bg-yellow-2 w-full h-fit p-5 md:p-5 flex flex-col justify-center items-center gap-y-8 md:gap-y-15">
      <div className="w-full flex flex-col items-center justify-center text-center gap-y-5 max-w-[1730px] mx-auto">
        <h1
