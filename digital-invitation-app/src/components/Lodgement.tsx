...
const InfoHotel: Hotel[] = [
  {
    ...
    phone: "312 316 4444",
    mapView:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3766.5189970325705!2d-103.69153682479002!3d19.259783781982964!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x84255a8c7db99e21%3A0x64c8723b96093751!2sFiesta%20Inn%20Colima!5e0!3m2!1ses-419!2smx!4v1749011935681!5m2!1ses-419!2smx",
  ...
  },
  {
    ...
    phone: "312 316 0750",
    mapView:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3766.774322312797!2d-103.705772!3d19.248664800000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x84255aa2a1b04c55%3A0x72c331e366fd08b3!2sHotel%20Mar%C3%ADa%20Isabel!5e0!3m2!1ses-419!2smx!4v1749012045522!5m2!1ses-419!2smx",
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col justify-center">
        ...
        />
        <p
          className={`${simonetta.className} text-black font-normal text-center mt-[24px] text-[16px] sm:text-[24px] xl:text-[32px]`}
        >
          Con mucho cariño, compartimos opciones de hospedaje para nuestros invitados que viajan
          desde lejos{" "}
        </p>
      </div>

      <div className="w-full flex flex-col px-[8px] md:flex-row justify-between gap-[24px] my-[24px]">
        {InfoHotel.map((info) => (
          <div
            key={info.name}
          ...
          >
            <h2
              className={`${tangerine.className} font-extrabold text-center text-red-brown text-[32px] sm:text-[40px] xl:text-[56px]`}
            >
              {info.name}
            </h2>
            <div className="w-full flex flex-row justify-items-start items-center gap-[16px]">
              ...
              <p
                className={`${simonetta.className} font-normal text-black text-[16px] sm:text-[24px] xl:text-[32px]`}
              >
                {info.location}
              </p>
            </div>
            ...
            <a
              className="w-full flex flex-row gap-[8px] justify-end hover:bg-[#f4f2eb] px-[24px] items-center"
              href={info.page}
              target="_blank"
              rel="noopener noreferrer"
            >
              <p
                className={`${simonetta.className} font-normal text-yellow-3 text-[16px] sm:text-[24px] xl:text-[32px]`}
              >
                {" "}
                Ir al sitio{" "}
              </p>
