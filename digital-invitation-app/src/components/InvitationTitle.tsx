...
export default function Invitation({ name, maxGuests }: InvitationProps) {
  return (
    <section
      id="invitation"
    ...
    >
      <div className="bg-yellow-2 w-full h-fit lg:p-[42] gap-[16px] flex flex-col justify-center rounded-[16px] invitation-background">
        <div className="w-full lg:px-[80px] flex flex-col justify-center">
          <h1
            className={`${tangerine.className} font-extrabold text-yellow-4 text-[48px] text-center`}
          >
            ¡Nos casamos!{" "}
          </h1>
          <span className="w-full flex flex-col gap-[24px] lg:px-[80px]">
            ...
            >
              &quot;Lo más grande que aprenderás en la vida será a amar y ser
              amado de vuelta&quot; <br />
              Moulin Rouge
            </p>
            <p
              className={`${simonetta.className} font-normal text-black text-[24px] text-center`}
            >
              Queremos compartir contigo la alegría de nuestra unión, y nos
              gustaría que nos acompañases a celebrar este momento tan especial
              para nosotros
            </p>
            <div className="w-full py-[24px] gap-[8px]">
              ...
              <p
                className={`${tangerine.className} font-bold text-red-brown text-[40px] text-center`}
              >
                {name}
              </p>
              <div className="flex flex-row justify-center align-middle gap-[8px]">
                <p
                  className={`${simonetta.className} font-normal text-yellow-4 text-[32px] text-center`}
                >
                  {maxGuests}
                </p>
                <p
