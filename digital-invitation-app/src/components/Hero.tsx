...
export default function Hero() {
  return (
    <div className="relative w-full min-h-[100svh] md:h-[900px] pt-4 md:pt-6 mx-auto overflow-hidden">
      {/* Background Image */}
      <Image
        src="/cover.png"
        alt="cover"
        fill
        className="object-cover sm:object-contain sm:object-[left_50%] md:object-cover "
        priority
      />
